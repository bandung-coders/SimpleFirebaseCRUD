...
import com.sh.firebasecrud.databinding.ItemUsersBinding
...
class MainAdapter: RecyclerView.Adapter<MainAdapter.ListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        ListViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_users, parent, false))
